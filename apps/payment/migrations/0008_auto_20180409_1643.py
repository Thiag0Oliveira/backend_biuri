...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='account_number',
            field=models.CharField(max_length=10, verbose_name='Número da Conta'),
        ),
        migrations.AlterField(
            model_name='bankaccount',
            name='account_type',
            field=models.CharField(choices=[('001', 'CONTA CORRENTE'), ('013', 'POUPANÇA')], max_length=10, verbose_name='Tipo da conta'),
        ),
        migrations.AlterField(
            model_name='bankaccount',
            name='agency',
