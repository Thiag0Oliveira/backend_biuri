# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-01-03 15:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('company_sale', '0008_auto_20190103_1524'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='voucher_service', to='service_core.Service')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AlterField(
            model_name='sale',
            name='observation',
            field=models.TextField(blank=True, max_length=500, null=True, verbose_name='Observações sobre a venda'),
        ),
    ]
